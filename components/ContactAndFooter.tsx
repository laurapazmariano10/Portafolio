...
export function ContactAndFooter() {
  ...
  return (
    <>
      <section id="contact" className="mx-auto grid max-w-[1120px] gap-20 bg-white py-28 px-6 md:px-10 lg:px-0 lg:grid-cols-[360px_560px] lg:items-center lg:justify-between">
        ...
        <div className="w-full max-w-[560px]">
          ...
          <form className="mt-10 space-y-6" onSubmit={handleContactSubmit}>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <button type="submit" className="inline-flex h-12 items-center justify-center rounded-full border border-[#6872F2] px-9 text-lg font-bold uppercase tracking-normal text-[#6872F2] transition-all duration-300 hover:bg-[#6872F2] hover:text-white">
                Enviar correo
              </button>
              <button type="button" onClick={handleWhatsAppSubmit} className="inline-flex h-12 items-center justify-center rounded-full bg-[#6872F2] px-9 text-lg font-bold uppercase tracking-normal text-white transition-all duration-300 hover:bg-[#5963e8]">
